...
export class Reflect {
    ...
    static getClass(obj: any): Class {
        return this.classes[obj.constructor.name.toLowerCase()];
    }

    static getClassByName(name: string): Class {
        return this.classes[name.toLowerCase()];
    }

    static setupClass(cls: Class) {
        this.classes[cls.name.toLowerCase()] = cls;
    }
}
...
export class Class {
    ...
    getMethod(name: string) {
        return this.methods[name.toLowerCase()];
    }
